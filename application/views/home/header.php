      ...
      <div class="row">
        <div class="col-sm-12">
          <div class="top-left pull-left">
            <div class="wel-come-msg"> Selamat datang di perpustakaan online MA AL HASAN ! </div>
          </div>
          <div class="top-right pull-right">
            <div id="top-links" class="nav pull-right">
              <ul class="list-inline">
                ...
                <?php }else { ?>
                  <li class="dropdown"><a href="#" title="My Account" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user" aria-hidden="true"></i><span>Akun saya</span> <span class="caret"></span></a>
                    <ul class="dropdown-menu dropdown-menu-right">
                ...
                <?php } ?>
                <li><a href="#" id="wishlist-total" title="Wish List (0)"><i class="fa fa-heart" aria-hidden="true"></i><span>Daftar Keinginan</span><span> (0)</span></a></li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div class="header-inner">
      ...
      <div class="col-sm-9 col-xs-9 header-right">
        ...
        <div id="cart" class="btn-group btn-block">
          <button type="button" class="btn btn-inverse btn-block btn-lg dropdown-toggle cart-dropdown-button"> <span id="cart-total"><span>Daftar Pinjaman</span><br>
