                    ...
                    <div class="panel-heading">
                        <div class="view-header">
                            ...
                            <div class="header-title">
                                <h3>Login</h3>
                                <small><strong>Masukkan informasi akun anda untuk login.</strong></small>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body">
                        <form action="" method="post" id="loginForm" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" title="Masukkan email anda disini" required="" value="admin@gmail.com" name="email" id="email" class="form-control">
                                <small class="text-danger"><?php echo form_error('email') ?></small>
                            </div>
                            <div class="form-group">
                                <label class="control-label" for="password">Password</label>
                                <input type="password" title="Masukkan password anda disini" value="admin" name="password" id="password" class="form-control">
